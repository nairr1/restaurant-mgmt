  ...
  return (
    <header className='fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-gray-100'>
          ...
          <div className='relative'>
            ...
            /> 
            {
              isMenu && (
                ...
                >
                  {
                    user && user.email === 'verrou.1199@gmail.com' && (
                      <Link to='/createItem'>
                        <p 
      ...
      <div className='flex items-center justify-between md:hidden'>
        ...
        <Link to={'/'} className='flex items-center gap-2'>
          <img src={Logo} className='w-10 object-covver' alt='logo'/> 
          <p className='text-headingColor text-xl font-bold'>
            City
          </p>
        </Link>
          ...
          /> 
          {
            isMenu && (
              ...
              >
                ...
                >
                  <li className='textbase text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer px-4 py-2 hover:bg-slate-300'>
                    Home
                  </li>
                  <li className='textbase text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer px-4 py-2 hover:bg-slate-300'>
                    Menu
